      ...
      <el-tabs v-model="currentTab" @tab-click="handleClick">
        <el-tab-pane label="发送记录" name="first">
          ...
          <div class="content-head">
            ...
            <el-button-group>
              <div class="headerBtnRight">
                <el-button size="small" class=" iconBtn active" style="margin-right:3px" @click="exportRepeat" v-has="'vmsMessageBatchMessageExport'" :disabled="exportBtnDisable">
                  <i class="iconfont icondaochu"></i>
                  导出
                </el-button>
                <el-button size="small" style="margin-right:3px" class="iconBtn" :class="{ 'active': !btnDisable }" :disabled="btnDisable" @click="repeat" v-has="'vmsMessageBatchWithdraw'">
                  <i class="iconfont iconshuaxin"></i>
                  失败重发
                </el-button>
              </div>
          ...
          <h-table :tableOptions="tableOptions" :operation="true" :data="data" v-loading="loading1" @select="selectValues">
            <template slot="expand" slot-scope="props">
              ...
              <div class="vms" v-else-if="props.row.messageContent && props.row.messageContent.messageType == 'VMS'">
            ...
            <template slot="operation" slot-scope="scope">
              <!-- <el-tooltip class="item" effect="dark" content="取消发送" placement="top">
                <img class="operation" src="../../assets/svg/icon_24px_审核不能过.svg" @click="cancaleSend(scope)" v-has="'vmsMessageBatchWithdraw'">
              </el-tooltip> -->
              <span class="operation" @click="cancaleSend(scope)" v-has="'vmsMessageBatchWithdraw'">取消</span>
              <!-- <el-tooltip class="item" effect="dark" content="发送详情" placement="top">
                <img class="operation" src="../../assets/svg/icon_24px_更多.svg" @click="toDetail(scope)" v-has="'vmsMessageSendRecordPageList'">
              </el-tooltip> -->
              <span class="operation" @click="toDetail(scope)" v-has="'vmsMessageSendRecordPageList'">详情</span>
            </template>
        ...
        <!-- <el-tab-pane label="接收记录" name="third">
          <div class="headerBtn">
            ...
            <el-select v-model="enterpriseAccountAppId3" placeholder="应用" size="small" clearable ref="appSelect3" @visible-change="appSelect3">
              <el-option v-for="item in appOptions" :key="item.id" :label="item.name" :value="item.id">
              </el-option>
            </el-select>
            <el-select v-model="status3" placeholder="状态" size="small" clearable ref="statusSelect3" @visible-change="statusSelect3">
            ...
            <div class="detail-contetn">
              <el-table border size="small" v-loading="loading3" tooltip-effect="dark" :data="receiveData" :style="{'color':'#333','min-height': (minHeight || '') + 'px'}"
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <span class="operation" @click="replyMessage(scope)" v-has="'vmsMessageReply'">回复</span>
                    <span class="operation" @click="handleDetails(scope.$index, scope.row)" v-has="'vmsMessageRecordView'">记录</span>
                  </template>
                </el-table-column>
              </el-table>
            </div>
