    ...
    <div class="content">
      <div class="content-left">
        ...
        <div class="content-left-button">
          <el-button type="primary" size="small" @click="importFiles" v-has="'messageAddressBookImport'">
            <i class="iconfont icondaoru"></i>
            导入文件
            <!-- <img src="../../assets/images1/icon_18px_导入.svg" style="width:14px;height:14px">导入文件 -->
          </el-button>
          <el-button type="primary" size="small" @click="addressBook" v-has="'messageAddressBookPageList'">
            <i class="iconfont icontongxunlu"></i>通讯录
            <!-- <img src="../../assets/images1/icon_18px_通迅录.svg" style="width:14px;height:14px">通讯录 -->
          </el-button>
        </div>
        <div v-show="messageType != 3">
      ...
      <div class="content-center">
        ...
        >
          ...
          <el-form-item label="消息模板：" prop="msg">
            <el-select v-model="ruleForm.msg" filterable size="small" placeholder="请选择">
              <el-option
          ...
          <el-form-item label="可用变量：" v-show="messageType == 3">
            ...
            <div v-else>
              <el-button v-for="(item,index) in variableList" :key="index" @click="variableSelect(item)" size="small" :disabled= "messageType != 3">{{item.name}}</el-button>
            </div>
          ...
          <el-form-item>
            <el-button type="primary" @click="handleSend" size="small" v-has="'messageSendMouldMessage'" :disabled="submitDisable">提交</el-button>
          </el-form-item>
        </el-form>
      </div>
          ...
          <div class="phone-box">
            ...
            <div class="footer-menu">
              ...
              <div class="menu-bottom">
                ...
                <el-input size="mini" placeholder="5G消息" style="margin-right:4px" readonly></el-input>
    ...
    handleSend() {
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          if (this.messageType == 3 && this.replaceParams.length == 0) {
      ...
      MessageMould(params).then(res => {
        if (res.data.status == 0) {
          ...
          if(data.messageType == 0) {  // 文本消息
            ...
            this.replaceWhich = 1
            this.order = []
            // this.variablePhoneNumner = this.phoneTotalList
          }
        } else {
          this.$message({
            type: 'error',
