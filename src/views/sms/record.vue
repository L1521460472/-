          ...
          <div class="content-head">
            ...
            <el-button-group>
              <div class="headerBtnRight">
                <el-button size="small" class=" iconBtn active" style="margin-right:3px" @click="exportRepeat" v-has="'smsMessageBatchMessageExport'" :disabled="exportBtnDisable">
                  <i class="iconfont icondaochu"></i>
                  导出
                </el-button>
                <el-button size="small" style="margin-right:3px" class="iconBtn" :class="{ 'active': !btnDisable }" :disabled="btnDisable" @click="repeat" v-has="'smsMessageBatchResend'">
                  <i class="iconfont iconshuaxin"></i>
                  失败重发
                </el-button>
              </div>
          ...
          <h-table :tableOptions="tableOptions" :operation="true" :data="data" v-loading="loading1" @select="selectValues">
            ...
            <template slot="operation" slot-scope="scope">
              <!-- <el-tooltip class="item" effect="dark" content="取消发送" placement="top">
                <img class="operation" src="../../assets/svg/icon_24px_审核不能过.svg" @click="cancaleSend(scope)" v-has="'smsMessageBatchWithdraw'">
              </el-tooltip> -->
              <span class="operation" @click="cancaleSend(scope)" v-has="'smsMessageBatchWithdraw'">取消</span>
              <!-- <el-tooltip class="item" effect="dark" content="发送详情" placement="top">
                <img class="operation" src="../../assets/svg/icon_24px_更多.svg" @click="toDetail(scope)" v-has="'smsMessageSendRecordPageList'">
              </el-tooltip> -->
              <span class="operation" @click="toDetail(scope)" v-has="'smsMessageSendRecordPageList'">详情</span>
            </template>
        ...
        <el-tab-pane label="发送详情" name="second">
          ...
          <div class="detail-contetn">
            <el-table border size="small" tooltip-effect="dark" v-loading="loading2" :data="detailData" :style="{'color':'#333','min-height': (minHeight || '') + 'px','line-height': '27px'}"
              ...
              <el-table-column label="消息模板"  width="140" show-overflow-tooltip>
                <template slot-scope="scope">
                  <span>{{scope.row.messageContent.content}}</span>
                </template>
              </el-table-column>
              ...
              <el-table-column label="发送通道" prop="channelId" width="150" show-overflow-tooltip></el-table-column>
          ...
          <div class="detail-content">
            <div class="detail-contetn">
              <el-table border size="small" v-loading="loading3" tooltip-effect="dark" :data="receiveData" :style="{'color':'#333','min-height': (minHeight || '') + 'px'}"
                ...
                <el-table-column label="送达时间" width="150" prop="deliverTime" show-overflow-tooltip></el-table-column>
                <el-table-column label="状态" prop="status"></el-table-column>
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <!-- <el-tooltip class="item" effect="dark" content="回复消息" placement="top">
                      <img class="operation" src="../../assets/svg/icon_24px_回复.svg" @click="replyMessage(scope)" v-has="'smsMessageReply'" />
                    </el-tooltip> -->
                    <span class="operation" @click="replyMessage(scope)" v-has="'smsMessageReply'" >回复</span>
                    <!-- <el-tooltip class="item" effect="dark" content="查看记录" placement="top">
                      <img class="operation" src="../../assets/svg/icon_24px_详情.svg" @click="handleDetails(scope.$index, scope.row)" v-has="'smsMessageRecordView'" />
                    </el-tooltip> -->
                    <span class="operation" @click="handleDetails(scope.$index, scope.row)" v-has="'smsMessageRecordView'" >记录</span>
                  </template>
                </el-table-column>
              </el-table>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      exportBtnDisable: false, // 导出按钮是否禁用
  ...
  methods: {
    ...
    initData(){
      Promise.all([this.getDataList(), this.getMessageLists(), this.getMessageTypeList()]).then(() => {
        this.getSendBatchList()
