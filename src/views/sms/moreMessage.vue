    ...
    <div class="content">
      <div class="content-left">
        ...
        <div class="content-left-button">
          <el-button type="primary" size="small" @click="importFiles" v-has="'smsMessageAddressBookImport'">
            <i class="iconfont icondaoru"></i>
            导入文件
            <!-- <img src="../../assets/images1/icon_18px_导入.svg" style="width:14px;height:14px">导入文件 -->
          </el-button>
          <el-button type="primary" size="small" @click="addressBook" v-has="'smsMessageAddressBookPageList'">
            <i class="iconfont icontongxunlu"></i>通讯录
            <!-- <img src="../../assets/images1/icon_18px_通迅录.svg" style="width:14px;height:14px">通讯录 -->
          </el-button>
        </div>
        <div v-show="messageType == 4">
      ...
      <div class="content-center">
        ...
        >
          ...
          <el-form-item label="可用变量：" v-show="messageType == 5">
            <!-- <div class="variable">
            ...
            <div>
              <el-button v-for="(item,index) in variableList" :key="index" @click="variableSelect(item)" size="small" :disabled= "messageType != 5">{{item.name}}</el-button>
            </div>
          ...
          <el-form-item>
            <el-button type="primary" @click="handleSend" size="small" v-has="'smsMessageSendMouldMessage'" :disabled="submitDisable">提交</el-button>
          </el-form-item>
        </el-form>
      </div>
          ...
          <div class="phone-box">
            ...
            <div class="footer-menu">
              ...
              <div class="menu-bottom">
                ...
                <el-input size="mini" placeholder="SMS消息" style="margin-right:4px" readonly></el-input>
...
export default {
  ...
  methods: {
    ...
    handleSend() {
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          if (this.messageType == 5 && this.replaceParams.length == 0) {
    ...
    // 删除联系人
    deletePhone(index) {
      const deleteWhich = this.phoneTotalList[index]
      this.variablePhoneNumner.forEach((item, index) => {
        if (deleteWhich == item[0].value) {
          this.variablePhoneNumner.splice((this.currentPage-1)*10 + index, 1)
        }
      })
    ...
    selectedAddressBook() {
      ...
      this.variableList = this.tableHeadList   // 替换变量列表等于表头
      const arr = []
      ...
      // console.log(this.variablePhoneNumner)
